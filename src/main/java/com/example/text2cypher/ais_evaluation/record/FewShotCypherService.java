...
@Service
public class FewShotCypherService {
    private final FewShotCypherRecordRepository fewShotCypherRecordRepository;

    public FewShotCypherService(FewShotCypherRecordRepository fewShotCypherRecordRepository) {
        this.fewShotCypherRecordRepository = fewShotCypherRecordRepository;
    }
    public List<FewShotCypherRecord> findAllByQueryType(QueryType queryType) {
        return fewShotCypherRecordRepository.findAllByQueryType(queryType);
    }
    public void create(String modelName, String question, GoldEntry gold, String predictedCypher, OlapCypherResponse result,
        ...
        FewShotCypherRecord cypherRecord = new FewShotCypherRecord();
        ...
        fewShotCypherRecordRepository.save(cypherRecord);
